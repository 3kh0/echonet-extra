...
const generatePassword = () => {
  ...
  if (lowercase.value) possibleCharacters += lowerCaseLetters;
  if (uppercase.value) possibleCharacters += upperCaseLetters;
  if (numbers.value) possibleCharacters += numberCharacters;
  if (special.value) possibleCharacters += specialCharacters;
